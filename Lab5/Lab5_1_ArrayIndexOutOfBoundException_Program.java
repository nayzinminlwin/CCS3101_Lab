...
public class Lab5_1_ArrayIndexOutOfBoundException_Program {
    public static void main(String[] args) {
        ...
        // array of dayCount in specific month
        ...
        } catch (InputMismatchException inpEx) { // exception for wrong datatypes
            System.out.println("Please enter only numbers.");
        } catch (ArrayIndexOutOfBoundsException arrEx) { // indexing rooms out of array
