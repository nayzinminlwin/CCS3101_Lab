...
public class TestShapeIO {
    public static void main(String[] args) {
        String parentPath = "Test2_Prac/Poly_n_Exceptions/ShapesIO/";
        String inputFile = parentPath + "shapes.txt";
        String outputFile = parentPath + "areas_report.txt";
        String errorFile = parentPath + "shapes_errors.log";
